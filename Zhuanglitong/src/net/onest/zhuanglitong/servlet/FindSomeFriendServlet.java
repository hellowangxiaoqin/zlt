...
/**
 * Servlet implementation class FindSomeFriendServlet
 */
@WebServlet("/FindSomeFriendServlet")
public class FindSomeFriendServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindSomeFriendServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<User> someUserList = friendDao.findSomeFriend(loginName,searchName);
