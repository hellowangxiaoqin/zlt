...
public class ComDynamicActivity extends Activity{
    private ViewPager viewPager;
    private LinearLayout point_group;
    private TextView image_desc;
    // 图片资源id
    private final int[] images = {R.drawable.advent1, R.drawable.advent2, R.drawable.advent3,
            R.drawable.advent4, R.drawable.advent5};
    // 图片标题集合
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button btn_pay1=findViewById(R.id.pay1);
        btn_pay1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
            }
        });
        Button btn_pay2=findViewById(R.id.pay2);
        ...
        Button btn_pay3=findViewById(R.id.pay3);
        btn_pay3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
        ...
        Button btn_pay4=findViewById(R.id.pay4);
        btn_pay4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
        ...
        Button btn_pay5=findViewById(R.id.pay5);
        btn_pay5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
        ...
        Button btn_pay6=findViewById(R.id.pay6);
        btn_pay6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
        ...
        Button btn_pay7=findViewById(R.id.pay7);
        btn_pay7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
        ...
        Button btn_pay8=findViewById(R.id.pay8);
        btn_pay8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ComDynamicActivity.this,ComPaymentActivity.class);
                startActivity(intent);
